...
def visualize_table(_graph: nx.DiGraph, _token_array: list, _witness_count: int):
    ...
    #     leading_unaligned_row = '<tr style="background-color: lightgray; border: 1px black solid; border-collapse: collapse;"><td style="background-color: pink;">unaligned</td>' + "".join(
    ...
    #             '<tr style="background-color: lightgray; border: 1px black solid; border-collapse: collapse;"><td style="background-color: pink;">unaligned</td>')
    ...
    #     # ###
    #     rows.append(
    #         '<tr style="background-color: beige; border: 1px black solid; border-collapse: collapse;"><td style="background-color: pink; border: 1px black solid; border-collapse: collapse;">' + str(
    #             index) + ' (' + str(
    #             end_token_offset) + ')</td><td  style="border: 1px black solid; border-collapse: collapse;" colspan="' + str(
