...
def import_witnesses():
    filenames = ['src/darwin/darwin1859.txt', 'src/darwin/darwin1860.txt', 'src/darwin/darwin1861.txt',
                 'src/darwin/darwin1866.txt', 'src/darwin/darwin1869.txt', 'src/darwin/darwin1872.txt']
